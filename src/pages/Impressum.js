  ...
  return (
    <div className='impressum'>
      ...
      <p><strong>Kontakt:</strong> 
          Telefon: 040-XXXXXXXX</p>
          </div>
          <div className='impressumText'>
          <div className='impreesumTextInhalt'>
          <p><strong>Haftungsausschluss: </strong><strong>Haftung für Inhalte</strong></p>
          ...
          <p>Bei Bekanntwerden von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen. </p> </div> 
          <div className='impreesumTextLinks'>
          ...
          <div className='impressumTextUerheberrecht'><h1><strong>Urheberrecht</strong></h1>
            ...
            <div className='impressumTextDatenschutz'>
            <hi><strong>Datenschutz</strong></hi>
            ...
            <div className='impressumTextGoogle'>
            ...
            <div className='impressumTextLink'>
